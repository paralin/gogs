...
import (
	...
	auth "gogs.io/gogs/pkg/auth"
)

// MockLoginSourcesStore is a mock implementation of the LoginSourcesStore
// interface (from the package gogs.io/gogs/pkg/db) used for unit
// testing.
...
// gogs.io/gogs/pkg/db) used for unit testing.
...
// interface (from the package gogs.io/gogs/pkg/db). It is redefined
...
// package gogs.io/gogs/pkg/auth) used for unit testing.
