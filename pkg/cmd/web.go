...
import (
	...
	"gogs.io/gogs/pkg/route/admin"
	apiv1 "gogs.io/gogs/pkg/route/api/v1"
	"gogs.io/gogs/pkg/route/dev"
	"gogs.io/gogs/pkg/route/lfs"
	"gogs.io/gogs/pkg/route/org"
	"gogs.io/gogs/pkg/route/repo"
	"gogs.io/gogs/pkg/route/user"
