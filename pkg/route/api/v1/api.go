...
import (
	...
	"gogs.io/gogs/pkg/route/api/v1/admin"
	"gogs.io/gogs/pkg/route/api/v1/misc"
	"gogs.io/gogs/pkg/route/api/v1/org"
	"gogs.io/gogs/pkg/route/api/v1/repo"
	"gogs.io/gogs/pkg/route/api/v1/user"
)
